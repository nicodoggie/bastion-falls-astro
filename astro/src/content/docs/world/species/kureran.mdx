...
[Feywild](../locations/feywild.mdx) during the
[Great Extinction](../events/draco-giant-war.mdx) brought about the conflict
between the [Dragons](dragon.mdx) and the [Giants](giant.mdx). Having brought
with them a deep understanding of various magical arts, they have developed a
tradition of magic that allowed them to access the unique raw chaotic energies
of the [Theran](../locations/thera.mdx) plane. They called this tradition,
[Ritma](../concepts/ritma.mdx).

Harnessing the power of Ritma, the Kurerans were able to expand from their first
Theran city of [Korad](../locations/korad-pass.mdx) to become a major power in
...
The Kurerans of [Korad](../locations/korad-pass.mdx), their first and greatest
...
[Alsatian Mountains](../locations/alsatian-mountains.mdx), their civilization as
