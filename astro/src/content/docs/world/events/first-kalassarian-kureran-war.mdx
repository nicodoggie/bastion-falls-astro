...
[Koradin Kurerans](/world/ethnicities/koradin-kurerans/). The mutual show of
...
agreements, the Kurerans argued that the *Kalassarian Empire* was no longer the
same entity as the *Republic of the Kalassus*. The argument was that, since the
