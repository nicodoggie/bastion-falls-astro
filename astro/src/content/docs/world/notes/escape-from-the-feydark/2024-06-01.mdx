...
A gargantuan airship seems to have left the docks at Ionguale,
seems to be heavily armed.
The bow seems to have something strange on it.
Colored grey.
...
The Dryads of the Opium Forest doesn't product opium,
it's interesting because it's the only source of the Mordayn herb.
