...
- Storms occasionally spawn from the origin, when storms pass,
  strange occurrences happen.
  Sometimes entire towns disappear, get displaced,
  or are replaced by some strange town form.
...
- A new religion formed based on worship of the magical origin.
  There are a couple of designated "prophets".
