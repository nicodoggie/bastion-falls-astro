...
The Silent Ages (435-1225 AI) represent a period of declining magical accessibility across Thera.
Recent scholarship suggests this wasn't simply a reduction in magical energy, but rather a
fundamental shift in how magic could be accessed through established methods like _Ritma_.
...
- [Senera](../../locations/senera/index.mdx) maintained stability longer
...
1. [Senera](../../locations/senera/index.mdx) and
...
1. [Dolo-Dolo](../../species/dolo-dolo.mdx)
   - Proximity to
     [Orbs of Enhancement](../../misc/orbs-of-power/orb-of-enhancement.mdx)
   - Mountain refuge
...
- [Fey Extinction Analysis](fey-extinction-analysis.mdx)
