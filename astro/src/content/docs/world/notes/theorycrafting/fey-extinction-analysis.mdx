...
with the notable exception of the [Dolo-Dolo](../../species/dolo-dolo.mdx).
This mass extinction event provides crucial insights into both magical biology
and the nature of planar connections.
