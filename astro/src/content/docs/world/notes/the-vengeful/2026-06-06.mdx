...
- Lord Boyle Eastonton and Miya summon Minfilia and Oscar.
  ...
  - The allied group operates between the Paladinate, the Kalassarian ruins beneath it, and the
    Green Lord grove or circle staging area.
...
- The party continues work around the
  [Orb of Absorption](../../misc/orbs-of-power/orb-of-absorption.mdx).
  - The `00:49:55-00:50:48` Anton and Minfilia discussion refers to the large Orb of Absorption in
    the Kalassarian ruins beneath the Eastonton Paladinate.
...
- Victims had been connected to the orb.
  ...
  - Miya and Boyle had previously found children spellcasters and eight adults placed there by
    paladins.
- Anton arrives as the engineer.
  - He brings copper for repairs.
  - His plan relies on nonmagical tools, ropes, pulleys, copper tubing, and manual work inside or
    near the orb's radius.
...
- A safe boundary is marked near the Orb of Absorption.
  ...
  - Bag of Holding transport through the field is treated as risky because contents may be
    destroyed.
...
- The party explores possible recovery methods.
  ...
  - They also wonder whether memories remain partly in the victim instead of only inside the
    parasite.
- Proposed research methods include:
  ...
  - Sending notes to [Mystine](../../characters/mystine-nightingale.mdx), who is actively
    researching memory recovery.
- Limits remain unresolved.
  ...
  - Parasites apparently cannot turn hosts into mind flayers without
    [Green Liquid](../../items/potion-of-aberrant-transformation.mdx), according to the flumph.
...
- The group rests before a morning meeting.
  ...
  - Sensodyne does not need sleep and guards the Paladinate while others rest, explore, or handle
    other business.
  - She is a devil and succubus, formerly the Marshall of the Pits, and part of the Rozenmaiden's
    crew.
- Minfilia stays with her undead.
  ...
  - Minfilia orders undead to "form a bed" and sleeps among them in a disturbing ritual-like
    arrangement.
...
- A captured Reformist caster is interrogated.
  ...
  - The group accounts for a possible hidden tooth, crunch trigger, suicide device, or escape
    mechanism.
...
- Henson serves Garward and the Reformists instrumentally.
  ...
  - He believes Rothschild may have transcended death, possibly as a vampire, lich, archlich, or
    something greater.
- Henson has a Great Old One patron.
  - "The powers" reject him despite several attempts.
  - A separate unclear answer may involve his patron or mistress protecting, rejecting, or detecting
    something.
...
- Mystine casts _suggestion_ on Henson.
  ...
  - Afterward, Henson clutches his head and says his Ring of Mind Shielding is probably gone or
    useless.
...
- Henson's route work remains important.
  - His task involved finding a path from the Paladinate to the Kalassarian ruins beneath Eastonton
    Manor.
...
- The Eastonton Manor lead grows stronger.
  ...
  - [Kotryna](../../characters/kotryna.mdx), the cat-woman court wizard and likely Draconic
    sorcerer, may be a notable combatant.
    - Her local Reformist hierarchy title is Bearer of Tears; other locales may have their own
      Bearers of Tears.
    - The "green drugs" line at `01:45:43-01:46:02` refers to Green Liquid, including Garward
      Eastonton Green Draught.
...
- Henson asks for proof the speaker is truly a different person.
  ...
  - Henson identifies the body as Sofia, the original owner of the body Minfilia's soul occupies
    after Iluvia Wunderplat's Soul Gem experiments.
...
- Mort's former life is described.
  ...
  - Mort claims to have won a war front by spending remaining life energy to raise dead comrades one
    by one.
...
- The Orb of Absorption remains distinct from god-cursed items.
  ...
  - Similar orbs may grow naturally elsewhere, but the installed orb's origin and manufacture remain
    unknown.
...
- The party reaches a sound-triggered trap corridor.
  ...
  - The chains enter through the mouth and cause fatal choking, internal compression, or related
    harm.
...
- Necromancy capabilities are reviewed.
  ...
  - Advanced necromancers can restore much of an undead creature's former life, possibly including
    spellcasting.
...
- The party discusses Feywild connections in Senera.
  ...
  - Asked whether Senera has an Archfey, Jessica points to the many Green Lord statues without
    confirming.
...
- Jessica explains baelnorns.
  - Baelnorns are elven undead guardians tied to ruins, tombs, homes, sacred places, artifacts, or
    bound locations.
...
- Jessica describes "pure" elves and Star Elves.
  ...
  - They are recognizable by pearl-white or translucent skin, pale eyelids, and white brows or
    lashes.
...
- A Star Court or Astrazalia scandal is discussed.
  - Star Elves may have been manipulated by Queen Valdas, previous Queen of the Spring Court and
    Queen of Mirrors.
  - [Somme](../../characters/somme-privatea.mdx) and
    [Rosy Conifer](../../characters/rosy-conifer.mdx) killed Valdas in the Feywild.
...
- Warlock knowledge becomes relevant.
  ...
  - The speaker suspects Feywild-returned friends are hiding something important, but does not want
    to force the issue.
...
- Skeletons form a bridge.
  ...
  - The group reaches a narrow corridor, turns right, and finds a hard-to-see upward spiral
    staircase.
...
- The Great Erected One is canon.
  - Minfilia, Oscar, and Cletus started a religion worshiping the Great Erected One in
    [Boyle Eastonton](../../characters/boyle-eastonton.mdx)'s image and life.
  - Characters who know Minfilia, Oscar, and Cletus tend to treat it as a joke, and Boyle is annoyed
    by it.
