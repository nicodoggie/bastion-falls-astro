...
- The party maps the statues onto the [Apgarian pagan](../../religions/paganism/apgarian/index.mdx) goddess portfolios.
...
- Miya contacts Minfilia with a sending stone from her Bag of Holding.
  ...
  - Guillerma and [Aigral Eastonton](../../characters/aigral-eastonton.mdx) remain missing or in danger.
...
- Jessica later voluntarily accepts another _planar binding_ after inviting the caster to say her name.
...
- Two rescued people are named.
  - Lannis is explicitly spelled L-A-N-I-S.
...
- A Ring of Mind Shielding protects an afflicted man's brain.
  ...
  - Minfilia removes most magic items into a Bag of Holding but keeps an [Orb of Repulsion](../../misc/orbs-of-power/orb-of-repulsion.mdx).
...
- Minfilia sends word that she is in danger and needs help.
  ...
  - Marky and Henry Surrata-Spellvig are assumed to be with the squad.
...
- The research center lies below or ahead.
  ...
  - Marky scouts about four figures near boxes, possibly in or near water.
...
- The party prepares for traps and counterspells.
  ...
  - Boyle and Marky rush through the trapped area, triggering explosive glyphs.
  - Repulsion protection appears to block mental trapping effects.
  - Initiative begins as Boyle and Marky reach the first spellcaster.
```
...
- The fight clusters near boxes by water and the route to the research room.
  ...
  - Boyle and Marky are hit but unaffected, confirming repulsion protection.
...
- Party actions break the enemy line.
  - Marky uses Steady Aim and Sneak Attack, killing or nearly killing enemies.
  - Marky poisons a badly wounded enemy after spending part of Sneak Attack damage.
...
- Minfilia proposes altering the teleportation circle's sigils.
  ...
  - [Mystine](../../characters/mystine-nightingale.mdx) later scratches or marks a circle with a rock, recalling a similar action at the Travertines.
...
- A woman later draws a circle around the huge object.
  ...
  - She teleports herself and the egg away to the [Hags of Hama](../../organizations/hags-of-hama.mdx) headquarters on Raibon Island.
...
- Minfilia believes the egg or baby resembles something connected to [Deep Lore](../../characters/deep-lore.mdx), the mysterious creature considered the source of the Hags of Hama's powers.
...
- Philippa would rather do it with Marky if she accepts.
