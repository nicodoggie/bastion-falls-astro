...
- The party secures a Kalassarian teleportation circle in the ruins.
  ...
  - It can function if powered by regular diamonds, charged orbs, or a normal _teleportation circle_
    spell.
- The circle has twenty available slots.
  - If all twenty are filled with charged orbs, the circle can be used once without casting the
    spell.
...
- The party reviews evidence that the Green Liquid does more than inspire fanaticism.
  ...
  - Minfilia shifts from seeing the subjects as mere fanatics to recognizing deliberate
    transformation.
...
- The Renaldi sample is used on Luke Malthrek to provoke a reaction.
  - Luke and Duchess Antoinette Malthrek appear to share a related infestation, parasite, aberrant
    condition, or linked affliction.
...
- Blood from devas, planetars, and aasimar can have healing, _greater restoration_, and
  _remove curse_ properties.
...
- Luke gives [Mark Malthrek](../../characters/mark-malthrek.mdx) water.
  ...
  - The scent trail ends at [Mark Malthrek](../../characters/mark-malthrek.mdx), suggesting
    _dimension door_ or similar magic.
...
- The party treats [Mark Malthrek](../../characters/mark-malthrek.mdx) as an immediate parasite or
  Reformist-control emergency.
  - They suspect the enemy was trying to reach him through the parasite, shard, or related
    influence.
  - Oscar is asked to make him sleep, but the group avoids overtly violent subdual.
- A fluid or preparation is administered.
  - Jessica's celestial blood appears involved because
    [Mark Malthrek](../../characters/mark-malthrek.mdx) is John Malthrek's brother.
...
- The party remains unsure what happened to [Mark Malthrek](../../characters/mark-malthrek.mdx)'s
  parasite.
...
- The shard may now be with [Mark Malthrek](../../characters/mark-malthrek.mdx), Duke Malthrek,
...
- Gwyniviere reacts badly when told [Mark Malthrek](../../characters/mark-malthrek.mdx) is in the
  dungeon.
  - She and Angel want details.
  - Part of the [Mark Malthrek](../../characters/mark-malthrek.mdx) situation is treated as
...
- Luke's marriage is part of the political repair.
  ...
  - [Mark Malthrek](../../characters/mark-malthrek.mdx), Matthew, and other Malthrek sons may become
    part of broader family stabilization.
...
- Parasite treatment
  ...
  - _Death ward_ is tested on a parasite, creature, or infected subject and makes it appear more
    lively.
- Katalin's known or discussed magic
  - Peace Cleric features include protective bonds and Balm of Peace.
  - Spells discussed include _detect poison and disease_, _spiritual weapon_, _daylight_,
    _death ward_, _resilient sphere_, _heroism_, _holy weapon_, _guiding bolt_, _bless_,
    _sanctuary_, _spare the dying_, _light_, _guidance_, _sacred flame_, _aid_, _calm emotions_, and
    _warding bond_.
...
- Travel and communication
  ...
  - _Sending_ is used or discussed for John, Justin, Hedwig, and others.
...
- Reformists
  ...
  - Their local operation includes Father Charles Renaldi, Pallia Travertine, Duchess Antoinette
    Malthrek, and other agents.
- Revivalists
...
- Aberrations
  ...
  - The party still does not know why widespread infected hosts have not already become mind
    flayers.
...
- Names and identities
  ...
  - Rislas or Rizlas.
  - [Mark Malthrek](../../characters/mark-malthrek.mdx), with earlier transcript variants including
    Mark, Marc, Moore, or Marquez.
  - Brasco, Brastok, Branrum, Montiela, Gavon, Donnie, Dan, Denise, Emma, Lev, Hermia, Sabine, and
    Avis.
...
- Places and terms
  ...
  - Kaskabe.
- Objects
  - Whether the sympathetic focus is underwear, a brooch, the Sapphire Brooch of Winter, or multiple
    objects.
...
- Magic and afflictions
  - Whether [Mark Malthrek](../../characters/mark-malthrek.mdx)'s lycanthropy is permanent,
    temporary, or a hybrid parasite/celestial-blood effect.
...
- Politics and family
  ...
  - Duke Malthrek's role in [Mark Malthrek](../../characters/mark-malthrek.mdx)'s geas and shard
    problem.
- Low-confidence social material
  - Peach John, Miguel Libero, Nightshift Nurses, Night Shift Marches, Legally Bear, face stealer
    jokes, and Apgar undergarment publication lore.
