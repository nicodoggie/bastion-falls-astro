...
- _Prestidigitation_ is mentioned in cleanup jokes.
...
## Bag Charms and Possession Risks
...
## Rachel, Junior, and Failed Domination
...
- Rachel attempts _Dominate Person_ on Dunweather.
...
- Rachel covers the failed spell as wild magic.
  ...
  - _Grease_ coats Rachel, Dunweather, Junior, and nearby surfaces.
...
- Dunweather turns confession into a sexualized coercive rite.
  - Rachel or Emily stays uncomfortable but uses the posture and language to survive and set up
    counterplay.
...
## Appoint Vessel and Greater Archon Bluff
...
- Rachel or Emily offers a _Lesser Restoration_ potion.
...
- Sponsors and possible sponsors include the Darlings Atelier, KS Prism, Enchante Workshop, Lolita
  and Pops, Warpstar, and Ashmodai.
...
- Henson the Golem is the stone golem Miya controls.
  - The entity remains Henson Eastonton when treated as a person, but the golem body is named
...
- Keep provisional until verified:
  ...
  - Darlings, stuffies, Hamlin, Warpstar, Sentimental Island, MSI, Nuran pizza, KS Prism, Love Bit,
    Strawberry Ray.
