...
- Castle Malthrek, near Mt. Thibris, is occupied by Reformist-aligned forces.
...
- The gathering appears to conceal a coup attempt.
  ...
  - Local hierarchy includes Candlebearer, Bearer of the Cup, and Bearer of the Whip.
  - Cupbearer is shorthand for Bearer of the Cup.
  - Bearer of the Whip can also be called Whip-bearer or Whiplaird.
...
- The party finds local Hicklander allies.
  - Martha's food house may know Mark from the estate.
  - Marjun, shortened from Marie-Jean, is the castle head chef and a Hicklander spy.
...
- Ellington provides surviving intelligence.
  ...
  - Fina is Proserfina Prunus Subhirtella, a changeling from the Feywild and Inkwell Academy
    researcher who studied Fey Crossings.
  - She loved exploring ruins, and the idea of exploring ruins in another world exhilarated her
    alongside her attachment to Cotto.
  - She adventured in the Feywild with Cotto and chose to come to Cotto's world after they fell in
    love.
...
- A second _Encode Thoughts_ extraction targets older memories.
  - The search focuses on shards, children, and trade.
...
- The deeper memory reveals child trafficking.
  ...
  - Elven children were sought to test whether elven shards had greater capacity.
...
## Shards, Mark, and Gwyniviere

- The party links Parvèse, shards, spellcasting children, and possibly magic items.
  - The exact relationship remains unresolved.
  - "Sliver" is not an established Bastion Falls term in this context.
  - The relevant pieces are shards of the broken Emerald Shield of Spring.
  - The word shard is descriptive of shattered pieces, not a world-spanning metaphysical category.
- The relevant Parvèse matriarch is Rosemunda Parvèse.
  - `Rosamunda` is a transcript/spelling drift, not the canonical spelling.
  - Rosemunda was exiled to the Feywild before parasites were discovered.
  - Her parasite status is therefore unknown, not confirmed infected or confirmed clean.
- Antoinette had an orb within the past year.
  - It gave or enabled limited magic.
  - She expected to receive her own shard after Mark was integrated, initiated, or infected.
...
- Emily, as Sister Rachel, is expected to meet someone tied to Lady Maribel Veyne.
  - Lady Maribel Veyne is tied to the Bearer of the Cup role, also called Cupbearer in shorthand.
...
- In the graveyard, Oren greets Emily in Elvish.
  ...
  - He knows she is meeting Lady Maribel Veyne tomorrow.
...
- Court wizards are suspicious.
  - Stacy is one of the court wizards.
  - Ellington says they are away gathering incoming vassals and supporters.
  - The wizards are meeting forces on the road rather than remaining at the castle.
  - They have been deployed to meet Viscount Leighman, Earl Barkres, Count Ranlis, and Viscount
    Monserrat.
  - One wizard may be strong enough for _Teleportation Circle_.
  - Others use _Dimension Door_ and possibly orbs for travel.
  - Their deployment appears connected to the wizard's tower.
...
- Fagus Malthrek resents Highbury.
  ...
  - Charlotte Highbury is Baron Dunum Highbury's daughter.
  - Charlotte bore Dorothy Marie Campbell with a nobleman known as Torch, not with Fagus.
  - Highbury hid Charlotte and the child at a secret estate.
  - Fagus allegedly found them and had them killed.
- Dorothy's body was never found.
  - Highbury still speaks of Dorothy, who hates being called Dottie.
  - Dorothy is Dorothy Marie Campbell, also known as Miya Campbell and Dorothy Highbury.
  - She is Charlotte Highbury's daughter and Baron Dunum Highbury's granddaughter.
  - The party connects her to Dorothy of the Hags of Hama, currently on Raibon Island.
  - Highbury later suggests testing her with **Where Ivy Dares to Grow** by **H.B. Charlie**.
- Monique or another niece remains unresolved.
...
- Emily performs immediate surgery.
  ...
  - Emily uses bracer tools, surgical implements, potions, _Lesser Restoration_, and a support
    necklace marked `L.H.`.
  - The initials stand for Lyudmila Hazeldine, Emily's full name.
  - The necklace is Emily's Periapt of Wound Closure.
...
- The party reaches the maze center.
  - Baron Highbury, not yet identified by the party, is being whipped and sexually assaulted.
  - Dame Elspeth Fenwick is the whip bearer.
...
- Mark transforms and drops invisibility when the cloak falls aside.
  ...
  - He mauls Fagus badly enough that Fagus would die if Mark were not stopped.
  - Emily or another ally calms Mark with touch and Animal Handling.
  - Fagus is left unconscious, then captured and bound.
  - The party keeps him alive because they need him to help clear Reformists from the Highbury
    barony.
- Fenwick is taken alive.
  - She remains blinded after Emily targets her eyes with _Magic Missile_.
  - She is magically bound or otherwise restrained strongly enough that Emily expects to
    _Counterspell_ anything she tries.
...
- _Greater Restoration_ is cast on Highbury.
  - The transcript context points to Emily as the caster, apparently using a _Greater Restoration_
    scroll or other limited casting source.
...
- Highbury is asked whether he still has family.
  - He first says no.
  - Dorothy Marie Campbell is raised as his granddaughter.
...
- Highbury proposes a verification question.
  - Ask Dorothy about **Where Ivy Dares to Grow** by **H.B. Charlie**.
...
## Miss Narmaya and Werewolf Threads

- Miss Narmaya is discussed as a vampire.
...
- People and identities
  - Confirm who remains in the library.
- Items and magic
