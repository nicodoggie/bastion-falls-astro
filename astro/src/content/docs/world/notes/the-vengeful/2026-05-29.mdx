...
- Sir Brastok is introduced as a guardian and plays cards with children.
  ...
  - The weapon is likely +3 and may be named Brannaugh.
...
## Sir Essen and the Keep

- Sir Essen is identified as head of staff and possibly second in command.
  - His name may also be rendered Essin or Eson in older transcripts.
...
- Essen takes interest in Charlotte.
...
- Charlotte and Edgar are recommended for permanent staff.
  - Paperwork is accepted or reviewed by Essen.
...
- Essen becomes an immediate threat.
...
- Charlotte prevents escalation with deception, magic, and the sleeping agent.
  ...
  - She touches Essen's painful piercing, kisses him, and administers the sleeping liquid.
  - Essen falls unconscious for eight hours.
...
## Essen's Room and Hidden Evidence

- Charlotte uses Essen's key.
  - The key number begins with 1, suggesting first-floor access.
  - Cross Murren escorts or assists her.
  - Cross knows Essen's pattern with private visitors when the Lord Commander is away.
- Essen's private room is much larger than the shared room.
...
- Confirm identities and spellings.
  ...
  - Essen, Essin, Eson, Cross Murren, Teresa, Felia, Boyle Eastonton.
...
- Clarify items and magic.
  ...
  - Brannaugh, the halberd given to Brastok.
