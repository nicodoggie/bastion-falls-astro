...
- The party is checking the Thralmal situation.
  ...
  - They distinguish a nearby volcanic pool site from the actual Thralmal pools.
  - The Thralmal pools are at Mt Brissimis.
...
- The hags frame promises carefully.
  ...
  - Inherited blood-bound obligations may survive even when the original promise-maker cannot keep
    them.
...
- Kelthyr reviews beholder lore from his own sketches.
  ...
  - Rays discussed include charm, paralysis, fear, slowing, enervation, telekinesis, sleep,
    petrification, disintegration, and death.
...
- Miya references Bob the Flumph from the earlier grove encounter.
  ...
  - The party increasingly treats strange or absurd claims from Oscar and Minfilia as potentially
    true.
...
- Emily may explain some monster lore from what she learned in Feywild schools.
  ...
  - Tiphanie recognized magical potential in John despite his lack of typical signs, such as yellow
    eyes or hair.
...
- Travel gear is discussed.
  ...
  - The party considers the hot pools near Mt Brissimis if seeking the Children of the Crone.
- Lord Boyle appears in an undead-horse thread.
  ...
  - Oscar and Minfilia may have a recent hag-linked undead arrangement involving bodies, offerings,
    and an unclear pool of monsters.
...
- The party reaches a volcanic lake or large pond.
  ...
  - It is near Mt Brissimis, but it is not the Thralmal pools themselves.
...
- Geysers at the site are dangerous.
  ...
  - When a geyser erupts near the party, blue sprites catch the heated droplets in shimmering blue
    globes.
...
- Reformist fanatics call drinking the Green Liquid ascension.
  ...
  - Emily or another speaker has seen many Green Liquid transformations that did not become mind
    flayers.
...
- Other threads surface.
  ...
  - The Princess of Anasai, Karni costume, Principium relics, and cracked coins come up as
    historical hooks.
...
- Marlion remains functional but wounded.
  ...
  - The sword's protection blocks magical effects, including magical healing.
...
- The party studies orb logistics.
  - Orbs can be placed around a _Teleportation Circle_ to let the party return without repeatedly
    spending diamonds.
...
- John retrieves Matthew's favorite fine-liner pen.
  ...
  - A stylized world map marks Senera far west, eastern lands, and Bastion as a deep purple-black
    circle.
...
- Minfilia immediately raises the Nothic as undead.
  - It retains natural abilities.
  - It does not retain spells.
  - Minfilia does not gain its truesight.
- Mental communication reveals Weird Insight.
  ...
  - Minfilia treats the undead Nothic like a prized pet.
- Minfilia takes a hair from a bag.
...
- The Prince is injured.
  ...
  - A _Cure Wounds_ attempt fails because the Topaz Sword of Summer makes him immune to magical
    effects, including magical healing.
...
- A necromantic beacon is raised or projected.
  ...
  - Nearby dead assets include insects, birds, squirrels, dissected frogs, and other small
    creatures.
...
- Major items:
  ...
  - Gem of True Sight.
  - Robe of the Archmagi from Timael's maze.
