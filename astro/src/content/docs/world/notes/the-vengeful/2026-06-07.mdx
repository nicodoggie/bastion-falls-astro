...
- The party reaches an upper level of the unnamed Kalassarian ruins beneath Eastonton Manor.
  ...
  - Preserved Crown or government records may exist at the University of Thrantorbury or Admiralty's
    Helm.
...
- The room is an alchemy laboratory or workroom.
  - It contains a central hearth, grate, exhaust, workbenches, bottles, flasks, and alchemical
    supplies.
...
- Two charred skeletons animate.
  ...
  - She also named a different undead zombie dog Dolly and gave it to
    [Philippa Vertin](../../characters/philippa-vertin.mdx)'s brother Philip as a pet.
...
- A spell scroll is found at the bottom of the stack.
  ...
  - If the party did not copy the spell before losing or consuming the scroll, the spell could be
    lost forever.
  - The spell can reconstruct damaged objects that remember their original shape from a one-inch
    cube fragment.
  - It can restore a defined object or section, such as a wing, floor, house-scale structure, or
    ruin section.
...
- The party debates shapeshifters and institutional rules.
  ...
  - The core threat is impersonation of authority figures to issue false orders or gain restricted
    access.

## Marcus Parnassus

- Minfilia, Oscar, Jessica, Henson Eastonton, and the intelligent undead skeleton Marcus Parnassus
  explore the ruin.
...
- Marcus behaves as a thinking person.
  ...
  - Minfilia can command them, but they are not constantly compelled like ordinary commanded
    skeletons.
...
- Marcus serves the party in a powered dining hall.
  ...
  - Ancient preserved food includes lamb, lentils, familiar but differently prepared dishes, and
    pungent fermented fish in amber liquid.
...
- Constructs from Estrega, a state in the
  [Apgarian Confederacy](../../organizations/apgarian-confederacy.mdx), become a major lead.
  ...
  - Marcus excitedly identifies the constructs as products of a Kalassarian research station in
    Estrega.
...
- Marcus leads the party toward the route they were supposed to take.
  ...
  - He enters a code and deliberately communicates it so the bonded undead or summoner can memorize
    it.
...
- The religion is presented as living doctrine.
  - It is inspired by Boyle Eastonton's patience, dignity, culture, suffering, and miraculous
    endurance.
...
- Outreach becomes practical.
  ...
  - One resident buys recent and older issues, praises the Great Erected One, and suggests free
    copies could help recruitment.
...
- Opening magic shapes the battlefield.
  - A plant-themed spell creates flowers and thorns around a guard, likely _wither and bloom_ or
    similar.
...
- Oscar uses the Ring of the Ram on a fleeing defender.
  - The prayer is framed through the Great Goat, the title the Followers of the Goat used for
    [Cotto](../../characters/cotto.mdx) when he experimented with deification in the Feywild.
...
- The captive lies about her status.
  ...
  - She later says she cannot be raised when dead, though the reason remains unclear and may be
    bravado.
...
- Natalia's deeper identity remains dangerous.
  ...
  - Natalia is a faithful member of the
...
- Tiphanie becomes central to Natalia's hopes.
  - The party describes Tiphanie as blue-haired, Feywild-linked, sometimes catlike or shifter-like,
    cursed by Baba Yaga, and having two sisters.
  - Natalia does not know Tiphanie and doubts that Tiphanie is her true name.
  - Natalia reacts strongly when told Tiphanie entered through a Fey crossing with the White
    Witches.
...
- The site beneath Eastonton has Feywild significance.
  ...
  - People from the [Skelmark County](../../locations/skelmark-county.mdx) area in northeastern
    Senera have been displaced for some time.
...
- Oscar worries about motherhood after Minfilia apologizes to him.
  ...
  - Natalia discusses abstinence, reproductive sacrifice, and power as real sacrifice, not just old
    coven tradition.
...
- The title of the Mother is contested across traditions.
  - [Aika Miura](../../characters/aika-miura.mdx) is called the Mother by pixies of the Feywild, and
    many fey accept the title.
  - Hags loyal to [Baba Yaga](../../characters/baba-yaga.mdx) refuse to recognize Aika as the
    Mother.
...
- Natalia gives family history around Garward.
  - Markle, [Boyle Eastonton](../../characters/boyle-eastonton.mdx)'s ex-wife, had feelings for
    Garward from childhood.
...
- Garward became involved with Markle despite her arranged marriage to Boyle.
  ...
  - The discovery that Markle cheated on Boyle with his own brother, despite her homely appearance
    and Boyle's patience with her, feeds her framing as the adversary of the Great Erected One.
...
- Henson Eastonton confesses a debt-bound past.
  ...
  - His father ruined the family finances through The Manatee, loans, mortgage, and racetrack
    betting.
...
- The Manatee becomes a trade and bounty hook.
  ...
  - Contacts at Racos Palma and [Shagnery](../../locations/nautillon.mdx) knew of a bounty.
  - A bounty was placed on the Manatee, and someone later claimed it.
  - Jargus leads Shagnery and delegates the dirty work.
...
- He admits dealings with the Children of the Crone.
  ...
  - He consigned an entire town to them in exchange for information about the Sapphire Brooch of
    Winter.
...
- Reformists wanted Aigral to retrieve the Ruby Amulet.
  - The [Ruby Amulet of Fall](../../novelty/the-elven-boons.mdx) is the Elven Boon tied to the
    Magarisok.
  - It was in Lord Malthren's possession and was the artifact at the center of the Narrows/Thane of
    the Magarisok route.
  - The prior Narrows setup put Aigral in charge of the Church mission after the Bishop of Surrey
    vouched for him.
  - Aigral's own route to power involved using the Thane of the Magarisok institution to get close
    to the King of Senera.
  - A bishop tried to reach Aigral through Murky Mabrams; notes that say Mark Malthrek here are
    likely transcript drift from "Marky."
  - Murky was too perceptive and careful, making the plan dangerous.
- Murky Mabrams, not Mark Malthrek, likely protected the Narrows; this appears to be a
  transcription drift from "Marky" to Mark.
...
- The threat is larger than Senera.
  ...
  - Hedwig, Sabria or Sabine, Alexandra, Avis, Deathengel, and Poasah all surface as wider-war
    links.

## Lunafeld and Strategic Contacts

- The party prepares to leave the hovel.
  - They plan to regroup, hold a private meeting, and report intelligence to Crown Prince Marlion or
    Steinar.
...
- The party returns to the Paladinate.
  ...
  - Aigral may object to turning the Paladinate toward the Great Erected One but also seems confused
    about his deity.
...
- Gear and money are sorted.
  ...
  - Items on the table include healing potion, Orb of Repulsion, scrolls, other orbs, white powder,
    and a telekinesis-like ring.
...
- Several orb leads remain active.
  ...
  - A cipher tube may use the Kalassarian independence date or Seneran founding date as its
    password.
...
- Another restored paladin wakes and believes he is dead.
  ...
  - He confesses that at barely seventeen, as a paladin of the Holy Order, he ran from the front
    lines after seeing "him."
...
- The Paladinate prepares to receive rescued people returning from temporary shelter at Admiralty's
  Helm.
  - They were rescued from beneath the Paladinate and sent to Admiralty's Helm for protection and
    healing.
...
- Healing capacity is insufficient.
  - Minfilia, a paladin of the Great Erected One, a cleric of the Angel of Justice, and possibly
    others can help.
...
- Katalin introduces herself.
  ...
  - Post-Kalassarian Tanduarians avoid calling themselves [Tandoor](../../ethnicities/tandoor.mdx)
    because the older ethnic label carries a barbaric connotation.
...
- Ma confirms she is fey.
  - Feywild pregnancies can proceed normally, speed up, freeze, change, or later involve replacement
    complications.
...
- The party considers a repulsion tactic.
  - Repulsion gear uses [Orbs of Repulsion](../../misc/orbs-of-power/orb-of-repulsion.mdx) to
    protect wearers from magical effects.
...
- Many ideas are weak or rejected.
  ...
  - Invisibility or a Cape of the Mountebank might help, but tremorsense and proximity remain
    problems.
- The party buys or negotiates for supplies.
  ...
  - Other wares include poisons, Alchemy Jug, Decanter of Endless Water, Sovereign Glue, Cloaks of
    Many Fashions, and a healing mace.
- The healing mace heals instead of harms.
  - Marcus backs away because normal healing may harm him.
  - Boyle tests it on Henson.
  - The party considers using it on rescued children but worries they might imitate it with a normal
    mace.

## Fire Sprites and the Transformed Snake

- The final working plan uses iron-eating fire sprites.
  - Henson fetches [Murky Mabrams](../../characters/murky-mabrams.mdx), heard in the transcript as
    Marky, using the Cape of the Mountebank or _Dimension Door_.
...
- Mark identifies nearby mountains.
  - [Mt Thibris](../../locations/mt-thibris.mdx) is the tallest mountain in the western Malthreks
    and second-tallest in Senera.
...
- Character beats surface during descent.
  ...
  - References to Sabina in this descent are transcription artifacts; Sabina is not a character or
    NPC and is not present.
  - Emily refuses help and descends confidently with elvish training and agility.
  - Rebecca is addressed as Your Majesty because Wonderland Syndrome leads her to believe she is
    Queen of Wonderland.
...
- Hedwig's secret return to [Nura](../../locations/nura.mdx) is mentioned.
  ...
  - Someone hopes Hedwig does not bring them because they do not want to be separated from a
    companion.
...
- Mark receives _detect magic_ through a rune.
  ...
  - The first rune is likely Emily's Rune of X-Ray Vision, which she frequently uses to prank Mark
    Malthrek.
...
- The group prepares disguises near the service door.
  - John changes into a servant or scullery disguise using Glamoured Leather Armor that Lime had
...
- Ruins and Kalassarian terms:
  - Talgito is likely a mistranscription of the Tagalog filler phrase "tawag dito"
    (`00:00:00-00:00:16`, `01:10:09-01:10:26`), not a lore term.
...
- Eastonton and Paladinate:
  ...
  - Emily's pregnancy moved to Emma for unclear reasons, which Emily describes as the pregnancy
    being stolen.
- Cat-person caster:
...
- Hags and Fey:
  ...
  - Aika Miura is called the Mother by pixies of the Feywild, while Baba Yaga-loyal hags recognize
    only Baba Yaga as the Mother.
...
- Items and magic:
  ...
  - The Ruby Amulet of Fall is the Magarisok Elven Boon tied to Lord Malthren, the Narrows, the
    Thane of the Magarisok, and Aigral's role in the Bishop of Surrey's mission.
  - Repulsion gear uses Orbs of Repulsion to protect wearers from magical effects, including the Orb
    of Absorption.
  - Red, purple, lighthouse, and absorber orb identities.
  - The fire snake's tremorsense, truesight, and transformed state remain unknown to the players
    because they never identified it correctly.
...
- Malthrek infiltration:
  ...
  - The wrong rune is likely Emily's Rune of X-Ray Vision, which she frequently uses to prank Mark
    Malthrek.
