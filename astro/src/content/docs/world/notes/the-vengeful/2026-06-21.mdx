...
- Miya is a model whose paintings were reproduced in [Legally Bare](../../organizations/legally-bare.mdx).
...
- Lime asks about partner availability.
  - She proposes a fey spirit partner or workaround for those without one.
...
- One fey manifestation resembles Hedwig.
  ...
  - Long ears.
  - Burnt-edged dress.
- The manifestation is identified as Arcadia, the Queen of the Autumn Court.
...
- A rescued boy is identified as Luana's missing cousin.
  ...
  - Working identities remain uncertain: Luana Victorique Dubreuil and possibly Benoit Marconne
    or Camden Dubreuil.
...
- A searched room contains travel souvenirs.
  ...
  - Apkar is corrected to Apgar.
- A magical scan uses a new-eyes detector method with an Absorption Orb.
  - A ward is found before the party does magic in the room.
  - A chest under the bed contains mostly nonmagical knickknacks.
  - One hidden magical item is found.
- The item is a small glowing star-shaped card or ornament.
  - Its true name remains unknown.
  - As a bonus action, speaking its command word while holding it grants advantage on all saving throws for 10 minutes.
  - It recharges at dawn.
- A brief bargain occurs around another magical item.
  - It is bought for 2 copper.
  - It is described as very rare or legendary.
  - Its source is The Book of Many Things, not the DMG.
```
...
- A spectral Strandiz image appears as a surge manifestation.
  ...
  - A possible _Gust_ cue remains uncertain.
```
...
- A necklace appears to provide protective or healing benefit.
...
```markmap
# Northcross and Fruit Trader Lead
...
- Reformist sites:
  ...
  - Track Northcross, Fruit Trader's Guild, and Bryan or Brian Street.
