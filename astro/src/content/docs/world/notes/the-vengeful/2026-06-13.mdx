...
- They worry about mind-affecting food or drink.
  ...
  - Castle Malthrek food comes mostly from Tawdita, the Malter River Valley, and the Western
    Lowlands.
...
- The Wizard's Tower becomes a possible target.
  ...
  - Expected defenses include wards, invisibility detection, noise detection, protections, and
    animated guardians.
...
- Lime, Justin, Rebecca, and others operate under kitchen-worker cover.
  ...
  - Rebecca, also called Becky or Beck, may be presented as a younger sister or the old recruiter's
...
- Poplar arrives from the Feywild.
  ...
  - Poplar notes that Minfilia eerily resembles Verenestra and begins to believe she may be an
    avatar of the archfey.
  - This later helps seed the cult of Lady Vanessa among the rickshaw drivers of Port Rainoso,
    Raibon.
- Emily Hazeldine describes her runecraft.
  - Her father, Keithgriff Hazeldine, invented a means of encoding any kind of spell into runic
    objects.
  - Emily is the group’s only practitioner of his method.
  ...
  - Her father could create more sophisticated runes containing higher-level spells.
...
- Emily made some Sending Stones.
  ...
  - She believes she can etch _Teleportation Circle_ if given a sigil and some magic, but has not
    yet succeeded.
  - She advises John to study like a wizard: writing, reading, preparing, memorizing, and
    practicing.
...
- Flower meanings are discussed.
  ...
  - Poisonous plants such as hemlock, wolfsbane, monkshood, belladonna, and nightshade are
    mentioned.
...
- Known or suspected Malthrek hierarchy roles include:
  ...
  - Bearer of Sadness.
  - Bearer of Joy.
- Father Karam Dunweather is the local Reformist priest.
  - He may also act as a local director or high-ranking operator.
...
- [Pecorine](../../characters/pecorine.mdx) is identified as a succubus.
...
- Malthrek is full of Reformist Church activity.
  ...
  - Mentioned figures include Bearer of the Cup, Bearer of the Whip, Lady or Maribel Veyne, and
    Isana Walburton.
