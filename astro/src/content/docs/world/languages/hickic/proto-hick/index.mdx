...
1. Initial fricative changes precede vowel coalescence
1. Compound-specific changes apply after basic sound changes
1. Unstressed vowel reduction applies last
...
1. Compound-Specific Changes (Early Proto-Hick)
