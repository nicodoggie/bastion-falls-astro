...
\*fen-inu : four : Note: Source of Early Hick fen. Shows counting form suffix
...
\*etha : that (medial-hidden/indirect inanimate/default) : Note: Source of Early Hick -eth

thir : air, wind; unseen moving force : Note: Native Early Hick renewal source of -thir as an
animate medial indirect demonstrative

\*ʔuma : that (distal inanimate/default) : Note: Source of Early Hick -um

\*ruma : that (distal animate) : Note: Source of Early Hick -rum; r- may preserve an older
pre-Proto-Hick animate-deictic linker
