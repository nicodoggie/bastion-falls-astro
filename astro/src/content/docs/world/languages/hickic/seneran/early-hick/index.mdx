...
Early Hick uses property words
(like English adjectives and adverbs) in three main ways:
...
whether a property word is acting like an adjective (before nouns) or an adverb
(after verbs).
