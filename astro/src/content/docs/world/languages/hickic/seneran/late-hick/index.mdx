...
Late Hick (105-400 AI) represents the crucial transition period
when Kalassarian influence began reshaping the Hick language into what would
become Modern Seneran.
...
<dt>
  <dfn>selmal</dfn> \[sel.mal]
</dt>

<dd>"seal pool" (Iut. sel + Hick mal)</dd>

<dt>
  <dfn>hvalbram</dfn> \[hval.bram]
</dt>
...
- [Middle Hick](/world/languages/hickic/seneran/middle-hick/)
- [Seneran](/world/languages/hickic/seneran/modern-seneran/)
...
This systematization laid the groundwork
for the modern Seneran distinction between occupational -ok
