...
Modern Seneran evolved primarily from Kalassarian, with substantial borrowings from the
[Hick language](../early-hick/index.mdx), particularly in maritime terminology and place names.

## Historical Development

Modern Seneran’s phonology reflects layered change from Hick through prolonged Kalassarian contact;
the chronological account appears under **Sound Changes** later on this page.
...
Brams \[brams]: Early Hick bram-aes "tidal flow": Middle Hick bramaes: Late Hick bramas: Sound
changes:
...
Inespell \[in.spell]: Early Hick innis-bél "island mouth": Middle Hick innesbel: Late Hick innesbəl:
Sound changes:
...
Skelward \[skel.ward]: Middle Hick skelward "shipping lane": Iut. \*skelward: Traditional navigation
term
...
Navrig \[nav.rig]: Kalassarian navrigium \< Lat. navigium "shipping registry": Ship registration
office
...
Stelar \[ste.lar]: Late Hick stel (stern) + Kalassarian -arius: Second officer (lit. "stern
officer")
...
Upner \[ʌp.nər]: Early Hick up-ner "upward-going": Modern: "uphill, ascending" (fossilized from up-

- -ner)

Donner \[dɒ.nər]: Early Hick don-ner "downward-going": Modern: "downhill, descending" (fossilized
from don- + -ner)
...
Brammer \[bræ.mər]: Early Hick bram-mer "tide-following": Modern: "downstream" (from bram- + -mer
"moving with")
...
Formal/Maritime Register: bat \[bat̚ʰ] "boat" (consistently aspirated): lak \[lak̚ʰ] "lake"
...
Compounds: me.imer \[me.ʔi.mer] ~ \[me.i.mer] "breath-flow": ka.amal \[ka.ʔa.mal] ~ \[ka.a.mal]
"pool-like"
...
1. Maritime Usage
   ...
   - -er restricted to temporary/trainee roles Example: skelok "ship's master" vs. skeler "temporary
     helmsman"

1. Trade/Craft Terms
   - -ok indicates guild membership/mastery
   - -er indicates apprenticeship/amateur status Example: smedok "master smith" vs. smeder
     "apprentice smith"
