...
from the [Hick language](../early-hick/index.mdx), particularly in maritime
...
Brams \[brams]: Early Hick bram-aes "tidal flow": Middle Hick bramaes: Late Hick
bramas: Sound changes:

- /ae/ → /a/ in unstressed syllables
- Final vowel deletion
- Preservation of -s as water feature marker

Inespell \[in.spell]: Early Hick innis-bél "island mouth": Middle Hick innesbel:
Late Hick innesbəl: Sound changes:
...
Havalbeck \[ha.val.bek]: Middle Hick haval-bek "whale stream": Iut. \*hval-bekk:
Sound changes:
...
Hegfell \[heg.fel]: Middle Hick heg-fell "high mountain": Iut. \*høg-fell: Sound
changes:
...
Wickmal \[wik.mal]: Late Hick vikmal "harbor pool": Specialized: "inner harbor,
protected anchorage"
...
Portor \[pɔr.tɔr]: Kalassarian portator "harbor master": Official title for port
administrator
...
Portric \[pɔr.trik]: Kalassarian portricum "port district": Administrative port
zone
...
Portmal \[pɔrt.mal]: Kalassarian port + Hick mal: Natural harbor under official
administration
...
Custamor \[kus.ta.mɔr]: Kalassarian customator "chief customs officer": Head of
port customs
...
Custor \[kus.tɔr]: Kalassarian custodiator "customs guard": Customs enforcement
officer
...
Kelnar \[kel.nar]: Hick kel (keel) + Kalassarian -narius: Ship's carpenter (lit.
"keel-keeper")
...
Utward \[ʌt.wərd]: Early Hick ut-ward "outward-motion": Modern: "seaward" (from
ut- "out" + -ward)

Inward \[ɪn.wərd]: Early Hick in-ward "inward-motion": Modern: "landward" (from
in- + -ward)
...
Inner \[ɪ.nər]: Early Hick in-ner "inward-going": Specialized: "heading to port"
(nautical term)
...
Urban Colloquial: Frequent diphthongization: ka.ir > kair \[kaɪ̯r]: se.al > seal
\[sɛːl]
...
ners \[nərs]: "narrowing of channel" (\< Early Hick neraes): Technical maritime
term
