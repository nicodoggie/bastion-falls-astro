...
**The Maltreks** are a range of mountains in the northwest of Senera. They are
the longest mountain range in Senera, stretching for over 100 miles. The
Maltreks refer to two arms of the range, the Northern Maltreks and the Western
Maltreks, which are divided by Interloper Pass. The entirety of the range is
...
[Havmals Ocean](havmals-ocean.mdx). To the east, by the Feetbowls. To the south,
by the Western Lowlands.

### Elevation

The highest point in the Maltreks is [Mt. Sinitar](mt-sinitar.mdx), at 3,100
feet above sea level, its lowest point is the
[Rocky Crevasse](rocky-crevasse.mdx), at 1,000 feet above sea level. On average,
the range is about 2,300 feet above sea level.
...
away the limestone. [Melpel's Canyon](melpels-canyon.mdx) close to the southern
tip of the range is one of the most notable features that show this contrast in
a spectacular fashion. The network of karsts connect to the
[Upper Malter River system](malter-river.mdx) at the
[Travertines](travertines.mdx), which feature waterfalls that gradually drop via
a stairway of rock.
...
begins in [Melpel Drop](melpel-drop.mdx) that carved the famous, eponymous
canyon.
...
inundate the boggy areas of the [Footbowl Basin](footbowl-basin.mdx) east of the
range.
...
springs of the [Belaitar Geyser Field](belaitar-geyser-field.mdx), making their
activity strongest during the wet spring and early summer months. Locals
venerate these geysers as an integral part of fertility and marital traditions,
and have drawn pilgrims into the area to both witness the phenomenon, and to ask
the spirits to bless them with children.

Year-round, the Western Maltreks karst system is the source a number of streams,
many of which feed into the [Malter River system](malter-river.mdx). Mountain
springs, either from well-springs or waterfalls are also fed by the consistency
of karst aquifers in collecting, holding and releasing ground water.
...
bringing significant moisture from the [Havmals Ocean](havmals-ocean.mdx).
Windward slopes face frequent storms and salt spray, while leeward valleys enjoy
