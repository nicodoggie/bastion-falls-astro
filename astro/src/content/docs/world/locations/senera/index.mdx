...
[Beteran Continent](/world/locations/betera/). Culturally, it is closely
integrated into the rest of the continent, due to its joint history, and its
involvement with a number of treaties and pacts with mainland states.
...
of tides, astronomy, and navigation. The
[Keelswood](/world/locations/keelswood/) preserves evidence of their
...
[Gulf of Inespell](/world/locations/gulf-of-inespell/) was particularly
...
As an island prefecture, it maintained both magically-powered transportation
networks (enabled by [Ritma](/world/concepts/ritma/)) and conventional maritime
routes.
...
When [Kalassus](/world/locations/kalassus/) fell in 466 AI, Senera was uniquely
...
Their close relationship with [Sanery](/world/locations/sanery/), which
maintained similar administrative continuity, allowed both regions to preserve
much of their shared Kalassarian heritage while developing distinct maritime
traditions.
...
new political dynamics. While [Baraon](/world/locations/baraon/) descended into
...
Through the [Treaty of Turain](/world/events/treaty-of-turain/), Senera secured
...
from Hick "thrantorgral", meaning "thousand peaks", divides Western from Eastern
...
[The Maltreks](/world/locations/the-maltreks/), are actually comprised of two
