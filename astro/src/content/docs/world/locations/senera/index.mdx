...
<Map client:only="react" src={processedImage.src} width={processedImage.options.width} height={processedImage.options.height} alt="Map of Senera" />

*Senera* is a large island kingdom to the northwest of the
[Beteran Continent](/world/locations/betera/). Culturally, it is closely integrated into
the rest of the continent, due to its joint history, and its involvement with a
number of treaties and pacts with mainland states.

It stands as *Arbiter of the Seas*, officially for the
[Sarmatian Sea](/world/locations/sarmatian-sea/), but de facto for the entire western leg
of the
...
[Great Gerim Sea](/world/locations/great-gerim-sea/) to the west of Senera and the
continent.
...
of tides, astronomy, and navigation. The [Keelswood](/world/locations/keelswood/) preserves
evidence of their sophisticated forestry management techniques.
...
The [Brams River](/world/locations/brams-river/) held particular significance in Hick
culture. Its name derives from the ancient Hick phrase "Bram-aes"
...
and astronomical navigation. The [Gulf of Inespell](/world/locations/gulf-of-inespell/) was
particularly important to Hick maritime activities, though many of their
practices were later suppressed or adapted during the Kalassarian period.

## Kalassarian Period (110-466 AI) \{#kalassarian-period}

During the
[Western Kalassarian Empire](/world/organizations/kalassarian-empire/)'s
...
transportation networks (enabled by [Ritma](/world/concepts/ritma/)) and
...
When [Kalassus](/world/locations/kalassus/) fell in 466 AI, Senera was uniquely positioned
to transition smoothly into independence, only formally declaring itself a
kingdom after the fall of the [Potol region](/world/locations/tanduaria#kalassarian-potol)
to the [Tandoor](/world/ethnicities/tandoor/).

## Rise of the Maidenfeld Dynasty (Late 460s)

The [House of Maidenfeld](/world/families/maidenfeld/) emerged from the ranks
...
Their close relationship with [Sanery](/world/locations/sanery/), which maintained similar
administrative continuity, allowed both regions to preserve much of their shared
Kalassarian heritage while developing distinct maritime traditions.
...
The fragmentation of the [Hapgarian region](/world/locations/hapgaria/) created new
political dynamics. While [Baraon](/world/locations/baraon/) descended into rebellion and
famine in the 440s, Senera's maritime connections initially helped it avoid the
worst of the crisis. The Maidenfelds capitalized on this stability to establish
their spice trade networks.

The rise of the [House of Dragonheart](/world/families/dragonheart/) marked a
shift toward more aggressive continental ambitions. This culminated in failed
military campaigns during the 900s, where two successive Seneran kings attempted
to expand territories southward and eastward. These campaigns proved costly,
...
Through the [Treaty of Turain](/world/events/treaty-of-turain/), Senera
secured significant control over maritime trade routes, establishing itself as a
...
The [Ranterg Mountain Range](/world/locations/ranterg-mountains/), its name, from Hick
"thrantorgral", meaning "thousand peaks", divides Western from Eastern Senera.
It is also the direct dominion of the Crown, and as such, the highest peaks are
...
[The Maltreks](/world/locations/the-maltreks/), are actually comprised of two geologically
distinct ranges that are connected at the northwestern corner of the island. The
Western Maltreks are a limestone-basalt formation, while the Northern Maltreks
are a basalt-silica formation.
...
Viscounties are the second lowest rank within the peerage. They are typically
granted by Earls or Thanes, but are also sometimes granted by Dukes or
Marquesses to cadet branches of their houses. Viscounties are usually granted
along with large contiguous agricultural estates in order to ease tax
collection.
...
of *electorship*. These electors are collectively called the *Noble Electorate*.
...
<aside class="sidebar">
  * Current Holder: [House Dragonheart](/world/locations/senera/noble-houses#house-dragonheart) -
    Seat: Thrantorbury - King: Threngral Dragonheart - Queen: Aelith
