...
[Beteran Continent](../betera/index.mdx). Culturally, it is closely integrated
...
of the [Seneran-Apgarian-Posaran Trade Route][trade-route], as well as for the
vast and largely uncharted [Havmals Ocean](../havmals-ocean.mdx) to the west of
Senera and the continent.
...
of tides, astronomy, and navigation. The [Keelswood](../keelswood.mdx) preserves
...
The [Brams River](../brams-river.mdx) held particular significance in Hick
...
and astronomical navigation. The [Gulf of Inespell](../gulf-of-inespell.mdx) was
...
When [Kalassus](../kalassus.mdx) fell in 466 AI, Senera was uniquely positioned
to transition smoothly into independence, only formally declaring itself a
kingdom after the fall of the [Potol region](../tanduaria.mdx#kalassarian-potol)
to the [Tandoor](../../ethnicities/tandoor.mdx).
...
Their close relationship with [Sanery](../sanery.mdx), which maintained similar
...
The fragmentation of the [Hapgarian region](../hapgaria.mdx) created new
political dynamics. While [Baraon](../baraon.mdx) descended into rebellion and
...
Through the [Treaty of Turain](../../events/treaty-of-turain.mdx), Senera
...
The [Ranterg Mountain Range](../ranterg-mountains.mdx), its name, from Hick
...
[The Maltreks](../the-maltreks.mdx), are actually comprised of two geologically
