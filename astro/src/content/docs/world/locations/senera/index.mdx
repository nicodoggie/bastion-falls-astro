...
[Beteran Continent](../betera/index.mdx).
...
[Sarmatian Sea](../sarmatian-sea.mdx), but de facto for the entire western leg
of the [Seneran-Apgarian-Posaran Trade Route][trade-route],
as well as for the vast and largely uncharted
[Havmals Ocean](../havmals-ocean.mdx) to the west of Senera and the
continent.
...
and navigation.
The [Keelswood](../keelswood.mdx) preserves evidence of their
...
The [Brams River](../brams-river.mdx) held particular significance in
Hick culture.
...
The [Gulf of Inespell](../gulf-of-inespell.mdx) was particularly
...
During the
[Western Kalassarian Empire](../../organizations/kalassarian-empire.mdx)'s
...
transportation networks (enabled by [Ritma](../../concepts/ritma.mdx)) and
...
When [Kalassus](../kalassus.mdx) fell in 466 AI,
...
[Potol region](../tanduaria.mdx#kalassarian-potol) to the
[Tandoor](../../ethnicities/tandoor.mdx).

### Rise of the Maidenfeld Dynasty (Late 460s)

The [House of Maidenfeld](../../families/maidenfeld.mdx) emerged from the ranks
of Kalassarian naval administrators who had governed Senera's maritime
prefecture. Unlike the violent transitions in many post-Kalassarian territories,
...
Their close relationship with [Sanery](../sanery.mdx),
...
The [House of Dragonheart](../../families/dragonheart.mdx)'s rise to power came
...
The fragmentation of the [Hapgarian region](../hapgaria.mdx) created
new political dynamics.
While [Baraon](../baraon.mdx) descended into rebellion
...
The rise of the [House of Dragonheart](../../families/dragonheart.mdx) marked a
...
When the [Poasan-Apgarian Conflict](../../events/poasan-apgarian-conflict.mdx)
...
Through the [Treaty of Turain](../../events/treaty-of-turain.mdx),
...
The [Ranterg Mountain Range](../ranterg-mountains.mdx), its name,
