...
cannibal in [Moreaux Island](../locations/moreaux-island.mdx) in particular is
referenced as proof of this, as their language preserves words and grammar that
are close to Estregan dialects that have not been as influenced by Kalassarian
...
[Silent Ages](../concepts/silent-ages.mdx) of Apgar. The kingdoms of Anasai,
Estrega and Sanery, at some point, have all claimed the islands, with the
islands being held by Estrega after the
...
administration of the province of [Sanery](../locations/sanery.mdx).
...
administered nominally by [Sanery](sanery.mdx), but in practice by a combination
of elected local officials, and the criminal organizations that retained their
