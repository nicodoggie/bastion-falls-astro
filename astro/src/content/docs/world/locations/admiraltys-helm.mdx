...
[Tidemark](/world/locations/tidemark). As the military and administrative heart
of Senera's naval operations, it coordinates maritime defense and naval
logistics across the region.

## Overview

Rising several hundred feet above the surrounding waters, the Helm provides
commanding views of both the [Brams River](/world/locations/brams-river) and the
\[Gulf of Inespell]\/world/(./gr
...
natural defenses, while the protected
[the Keelswood](/world/locations/keelswood) covers much of the remaining
terrain.
