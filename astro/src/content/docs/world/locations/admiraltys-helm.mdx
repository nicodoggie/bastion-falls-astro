...
[Tidemark](tidemark.mdx). As the military and administrative heart of Senera's
...
commanding views of both the [Brams River](brams-river.mdx) and the \[Gulf of
Inespell]\/world/(./gr
...
natural defenses, while the protected [the Keelswood](keelswood.mdx) covers much
of the remaining terrain.
