...
<Map client:only="react" src={processedImage.src} width={processedImage.options.width} height={processedImage.options.height} alt="Map of Surrey-on-the-Brams" />

**Surrey-on-the-Brams** is a large island situated where the
[Brams River](/world/locations/brams-river) meets the
[Gulf of Inespell](/world/locations/gulf-of-inespell). The island's strategic position has
made it home to [Port Surrey-on-the-Brams](/world/locations/port-surrey-on-the-brams), one
of Senera's most important cities.
...
formation split into two islands by a channel the locals call *the Ear's Canal*.
...
[Port Surrey-on-the-Brams](/world/locations/port-surrey-on-the-brams) being the largest and
most significant. Other settlements include:
