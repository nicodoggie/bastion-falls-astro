...
[Princely Channel](princely-channel.mdx), with a mouth approximately 63 miles
wide. The gulf serves as the outlet for the [Brams River](brams-river.mdx), one
of Senera's major waterways.
...
[Port Surrey-on-the-Brams](port-surrey-on-the-brams.mdx), a significant island
...
During the [Silent Ages](../concepts/silent-ages.mdx), particularly after the
rise of the
[Church of the Divine Masochist](../religions/divine-masochism/index.mdx), these
magical explanations were officially denounced as superstitious folklore. Church
scholars reinterpreted the name "Inespell" as a corruption of older words for
"inner harbor" or "sheltered waters, " and attributed the gulf's protective
...
[Fall of Bastion](../events/fall-of-bastion.mdx) renewed interest in these
ancient accounts.
...
During the [Silent Ages](../concepts/silent-ages.mdx), the gulf maintained its
...
features, with [Port Surrey-on-the-Brams](port-surrey-on-the-brams.mdx) serving
as a major commercial hub. The gulf is under the protection of the
[Seneran Navy](../organizations/seneran-royal-navy.mdx), which maintains several
facilities along its shores.
