...
**Tidemark** is the southern of the twin cities on Surrey-on-the-Brams, controlling the southern
channel (Bramsward Way) and the crucial Wardcross bridges. Originally a Hick settlement, it
developed into a major transfer point between river and land trade.
...
A specialized industrial district managing timber processing from the Admiralty- controlled
Keelswood, characterized by:
...
The ancient road to the Helm, predating Kalassarian occupation, winds through managed forest
sections that have supplied timber since pre-imperial times.
...
Located along the Middle Rise of Admiralty Rise (see [Thoroughfares](#major-thoroughfares)), the
lumber industry serves both local construction and shipbuilding needs.
...
- [The Admiralty's Helm](admiraltys-helm.mdx)
- [Keelswood](keelswood.mdx)
