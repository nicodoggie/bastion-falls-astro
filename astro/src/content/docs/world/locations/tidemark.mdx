...
controlling the southern channel
(Bramsward Way) and the crucial Wardcross bridges.
Originally a Hick settlement,
it developed into a major transfer point between river and land trade.
...
The ancient road to the Helm, predating Kalassarian occupation,
winds through managed forest sections that have supplied timber
since pre-imperial times.
...
Located along the Middle Rise of Admiralty Rise
(see [Thoroughfares](#major-thoroughfares)),
...
- [The Admiralty's Helm](/world/locations/admiraltys-helm)
- [Keelswood](/world/locations/keelswood)
