...
[L' Illes Apgarie](l-illes-apgarie.mdx) archipelago. Its governance, nominally,
is part of the [Sanery](sanery.mdx) region, but enjoys a special status due to
the [Treaty of Turain](../events/treaty-of-turain.mdx). Its defacto government
is split between its major settlements: most of recent history, this meant
[Port Rainoso](port-rainoso.mdx) and [Port Tressemer](port-tressemer.mdx).
...
[Sarmatian Sea](sarmatian-sea.mdx) trade routes with Northwestern Betera, has
made it a major economic center for the region. Most of the economic wealth
created, however, is controlled by the many criminal organizations that are
based in the island.
...
across the [L'Ille Apgarie](l-illes-apgarie.mdx) archipelago, including Raibon
Island. The people who settled the island called themselves the _Hausi_.
Surviving Kalassarian documents record the name of the island as _Mausia_
mentioning that it was derived from the name of the native people. The
...
The [Town of Hama](town-of-hama.mdx) was founded on the site the native Hausi
