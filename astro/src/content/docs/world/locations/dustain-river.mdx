...
[Trabar's Peak](trabars-peak.mdx), which then collects into aquifers and lakes,
most notably the lakes [Soiree](lake-soiree.mdx) and [Runir](lake-runir.mdx).
Water flows down primarily through the [Beauchane Falls](beauchane-falls.mdx)
into the river's _headwaters_.
