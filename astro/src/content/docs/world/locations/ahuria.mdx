...
[Thera](../locations/thera.mdx). It is the only known entity with land holdings
in all three continents, with eleven of its fourteen administrative regions,
called _Principalities_, in Ralaka. The twelfth,
[Kolha](../locations/kolha.mdx), is in Southern
[Betera](../locations/betera/index.mdx). The thirteenth and fourteenth are in
the westernmost edge of [Tarsa](../locations/tarsa.mdx)
...
[Tarsa](tarsa.mdx) refers to the continent to the east of Betera, and is
connected by the [Isthmus of Bastion](isthmus-of-bastion.mdx). On its eastern
shore, the Ahurian possessions of [Giza](giza.mdx) and
[Manascula](manascula.mdx) can be found.
...
outside of the Ralakan Continent. The Great Ahoriyata himself, along with his
youngest child had led the invasion force that took most of the South Central
Kalassar, which encompasses that is now known as Southern Poasah, Kolha, Ar,
Mir, Ralamba, Sarha, Sur and the Talamir Island.
