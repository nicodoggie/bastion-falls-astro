...
themselves as *Erkirgral*. This internal name serves as both an identifier of
...
immediately clear to potential supporters, while *Erkirgral* functions as a
password of sorts among committed members, used in private meetings and secret
correspondence.

## Etymology and Language

The organization claims *Erkirgral* derives from Early Hickic elements (*er-*
"one who" + *kir* "chest" + *gral* "land"). However, linguistic scholars note
several issues with this construction. The agentive marker *'er* was
historically used as a suffix, not a prefix, and the actual Early Hickic term
for "person" was *'al*, with *ma'al* serving as its collective form.

Members refer to each other individually as *erkir*, reflecting their
