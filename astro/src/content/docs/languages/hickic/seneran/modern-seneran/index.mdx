...
from the [Hick language](/languages/hickic/seneran/early-hick/), particularly in maritime
...
* \[Hick Language]\(/hick/)
* \[Kalassarian Language]\(/kalassarian/)
* \[Seneran Maritime Traditions]\(/culture/seneran-maritime/)
