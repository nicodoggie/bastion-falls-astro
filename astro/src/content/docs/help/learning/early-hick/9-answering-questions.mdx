...
- answer a yes/no question with a full sentence or a short echo;
- make a "no" answer by using `mo-`, the "not" prefix.
...
To answer "no," negate the word being denied. Use `mo-`, the "not" prefix.
