...
extraMetadata:
  ...
  image:
    url: /src/assets/characters/darnell-marrick.webp
    attribution: Created with pixlr.com
  character:
    age: "52"
    date_of_birth: 1223-08-15 AI
    pronouns: He/Him
    sex: Male
    position: Lord Mayor
...
*Darnell Marrick* is the current Lord Mayor of
[Tidemark](/locations/tidemark/). A former merchant captain from a
prominent maritime administrative family, he is known for his strict but fair
governance of the southern twin city.
