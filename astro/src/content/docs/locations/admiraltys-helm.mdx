...
[Port Surrey-on-the-Brams](/locations/port-surrey-on-the-brams) and
[Tidemark](/locations/tidemark). As the military and administrative heart of Senera's
naval operations, it coordinates maritime defense and naval logistics across the
region.

## Overview

Rising several hundred feet above the surrounding waters, the Helm provides
commanding views of both the [Brams River](/locations/brams-river) and the
\[Gulf of Inespell]\(/(./gr
...
natural defenses, while the protected [the Keelswood](/locations/keelswood) covers
much of the remaining terrain.
...
* [Keelswood Way (Tidemark)](/locations/tidemark#keelswood-way)
* [Admiralty Way (Port Surrey)](/locations/port-surrey-on-the-brams#admiralty-way)
