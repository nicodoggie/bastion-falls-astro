...
location:
  ...
  details:
    ...
    details:
      flag: {}
      map:
        alt: Map of Port Surrey-on-the-Brams
      government: {}

---

**Port Surrey-on-the-Brams** is a major port city in the [Seneran](/locations/senera)
island of [Surrey-on-the-Brams](/locations/surrey-on-the-brams). It is situated where
the [Great Surrey Reach](/locations/great-surrey-reach) meets the
[Gulf of Inespell](/locations/gulf-of-inespell). The city operates under oversight
from [The Admiralty's Helm](/locations/admiraltys-helm), which rises on the plateau
above, housing the command center of the
[Royal Seneran Navy](/organizations/seneran-military#navy).
...
*[Ritma](/concepts/ritma/)* enchantments can still be found in the
...
As enforcer of the [Treaty of Turain](/events/treaty-of-turain/), Port
