...
[Beteran Continent](/locations/betera/). Culturally, it is closely integrated into
...
[Sarmatian Sea](/locations/sarmatian-sea/), but de facto for the entire western leg
of the
[Seneran-Apgarian-Posaran Trade Route](/seneran-apgarian-posaran-trade-route/),
as well as for the vast and largely uncharted
[Great Gerim Sea](/locations/great-gerim-sea/) to the west of Senera and the
continent.
...
of tides, astronomy, and navigation. The [Keelswood](/locations/keelswood/) preserves
...
The [Brams River](/locations/brams-river/) held particular significance in Hick
...
and astronomical navigation. The [Gulf of Inespell](/locations/gulf-of-inespell/) was
...
During the
[Western Kalassarian Empire](/organizations/kalassarian-empire/)'s
...
transportation networks (enabled by [Ritma](/concepts/ritma/)) and
...
When [Kalassus](/locations/kalassus/) fell in 466 AI, Senera was uniquely positioned
to transition smoothly into independence, only formally declaring itself a
kingdom after the fall of the [Potol region](/locations/tanduaria#kalassarian-potol)
to the [Tandoor](/ethnicities/tandoor/).

## Rise of the Maidenfeld Dynasty (Late 460s)

The [House of Maidenfeld](/families/maidenfeld/) emerged from the ranks
...
Their close relationship with [Sanery](/locations/sanery/), which maintained similar
...
The [House of Dragonheart](/families/dragonheart/)'s rise to power came
...
The fragmentation of the [Hapgarian region](/locations/hapgaria/) created new
political dynamics. While [Baraon](/locations/baraon/) descended into rebellion and
...
The rise of the [House of Dragonheart](/families/dragonheart/) marked a
...
When the [Poasan-Apgarian Conflict](/events/poasan-apgarian-conflict/)
...
Through the [Treaty of Turain](/events/treaty-of-turain/), Senera
...
The [Ranterg Mountain Range](/locations/ranterg-mountains/), its name, from Hick
...
* Highest peak: [Mount Thraltor](/locations/mt-thraltor/) (4,200 ft)

### The Maltreks

[The Maltreks](/locations/the-maltreks/), are actually comprised of two geologically
...
* Peak: [Mt Sinitar](/locations/mt-sinitar/) (3,100 ft)
...
<aside class="sidebar">
  * Current Holder: [House Dragonheart](/locations/senera/noble-houses#house-dragonheart) -
