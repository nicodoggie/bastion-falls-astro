...
away the limestone. [Melpel's Canyon](/locations/melpels-canyon) close to the
...
entrances. Near [Mt Thibris](/locations/mt-thibris), smooth ancient lava tubes were
...
begins in [Melpel Drop](/locations/melpel-drop) that carved the famous, eponymous
canyon.
...
inundate the boggy areas of the [Footbowl Basin](/locations/footbowl-basin) east of
the range.
...
springs of the [Belaitar Geyser Field](/locations/belaitar-geyser-field), making
...
many of which feed into the [Malter River system](/locations/malter-river). Mountain
