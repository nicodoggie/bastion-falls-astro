...
They called their settlement *Surrata: safe harbor* in their language, and the
lands around this little islet, *Seneria: the Land of Glamour*. Of course, the
islet itself was already inhabited by the *Hick* peoples, in particular, the
tribe of the *Magarisok*, who called it *Garbasam: the Stone upon the Flow*.
