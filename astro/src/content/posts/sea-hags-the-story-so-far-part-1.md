...
We've been playing the *Sea Hags* campaign set in the world of Bastion Falls'
...
[Port Rainoso](../locations/port-rainoso.mdx), a pair of *Seneran Frigates*
...
that the ancients called the *Ritma*. Somme revealed that they were looking for
...
her. He found that Hedwig might be what was called a *hexblood*--a person borne
from an exchange with a group of magical women called *Hags*. He arranged travel
...
of La Carnalis were members of *La Camaraderie de la Mer*, a group borne out of
the Poasan-Apgarian Conflict. Two years prior, the pair served as officers of an
entirely different ship called the *Principium*, with Jean-Paul as first mate,
...
Descargar called the *Shriek Shack* that housed a coven of hags called the
...
a price. The group ordered a local beverage, *coco rum*, a rum flavored with
...
The group was served an Estregan dish called *Maherazi*, a pungent fermented
