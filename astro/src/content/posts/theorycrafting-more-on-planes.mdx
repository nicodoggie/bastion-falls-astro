...
In a previous [post](/blog/theorycrafting-planes), I talked about the concept of
*sources* and *sinks*, where sources are where raw magical energy flow out and
sinks are where magical energy flow in. I also went on about *Ideal Planes*
...
gets collected in basins. And where there's an abundance of water, life
flourishes--these basins spawn and support diverse ecosystems.
...
Often, it bring some of the minerals, nutrients and life with it, and it
collects into a much larger basin further down the line, where all of the
various networks of flowing water eventually collects.
...
ideas that are fostered in these interstitial sinks, are carried off further
down the line into bigger sinks.
...
overflow from all the upstream Vivial Basins form separate *idealized*
containers.
