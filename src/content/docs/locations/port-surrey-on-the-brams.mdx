...
**Port Surrey-on-the-Brams** is a major port city in the [Seneran](./senera.mdx)
island of [Surrey-on-the-Brams](./surrey-on-the-brams.mdx). It is situated where
the [Great Surrey Reach](./great-surrey-reach.mdx) meets the
[Gulf of Inespell](./gulf-of-inespell.mdx). The city operates under oversight
from [The Admiralty's Helm](./admiraltys-helm.mdx), which rises on the plateau
above, housing the command center of the
[Royal Seneran Navy](../organizations/seneran-military.mdx#navy).
...
_[Ritma](../world-novelty/ritma.mdx)_ enchantments can still be found in the
