...
[Beteran Continent](../betera.mdx). Culturally, it is closely integrated
...
[Sarmatian Sea](../sarmatian-sea.mdx), but de facto for the entire
western leg of the
...
of tides, astronomy, and navigation. The [Keelswood](../keelswood.mdx)
...
[Gulf of Inespell](../gulf-of-inespell.mdx) was particularly important
...
When [Kalassus](../kalassus.mdx) fell in 466 AI, Senera was uniquely
...
The [House of Maidenfeld](../../families/maidenfeld.mdx) emerged from the ranks of
...
Their close relationship with [Sanery](../sanery.mdx), which maintained
...
political dynamics. While [Baraon](../baraon.mdx) descended into
...
The rise of the [House of Dragonheart](../../families/dragonheart.mdx) marked a shift
...
Through the [Treaty of Turain](../../events/treaty-of-turain.mdx), Senera secured
...
The [Ranterg Mountain Range](../ranterg-mountains.mdx), its name, from
...
[The Maltreks](../the-maltreks.mdx), are actually comprised of two
