...
[Beteran Continent](../betera.mdx). Culturally, it is closely integrated into
...
of the
[Seneran-Apgarian-Posaran Trade Route](../seneran-apgarian-posaran-trade-route.mdx),
...
During the
[Western Kalassarian Empire](../../organizations/western-kalassarian-empire.mdx)'s
...
transportation networks (enabled by [Ritma](../../world-novelty/ritma.mdx)) and
...
<aside class="sidebar">
  * Current Holder: [House Dragonheart](./noble-houses.mdx#house-dragonheart) -
