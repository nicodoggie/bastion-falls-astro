...
**The Narrows** represents one of \[Surrey-on-the-Brams]\(./surrey-on-
the-brams.mdx) earliest maritime settlements. While the pre-Kalassarian peoples
...
[Kalassarian Senera](./senera.mdx#kalassarian-period). With the cooperation of
the Magarisok tribe, the Kalassarians established an early foothold in the Brams
...
The town square of The Narrows, locals call it Revgral or *Reeve's Land* as it's
...
It's also called the *Lost and Found* because "lost" shipments often find
themselves here.
...
<dl>
  ...
  <dt>
    <dfn>bramwardeth</dfn> \[bram.war.deθ]
  </dt>
