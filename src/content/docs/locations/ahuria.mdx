...
claims possession the entirety of the continent of [Ralaka](./ralaka/index.mdx).
and the Gizan Peninsula, as well as a huge portion of the eastern half ot the
Mirian Peninsula.

# Geography

Ahuria is one of the largest political entities in [Thera](./thera.mdx). It is
the only known entity with land holdings in all three continents, with eleven of
its fourteen administrative regions, called _Principalities_, in Ralaka. The
twelfth, [Kolha](./kolha.mdx), is in Southern [Betera](./betera/index.mdx). The
thirteenth and fourteenth are in the westernmost edge of [Tarsa](./tarsa.mdx)
...
[Posaran Sea](./posaran-sea.mdx), to the west by the
[Sarham Sea](../location/sarham-sea.mdx), and to the east by the
[Sea of Giza](./sea_of_giza.mdx).
...
[Kolha](./kolha.mdx), Ahuria's twelfth administrative principality, is isolated
from the rest of Ahuria, in the center of the Beteran Landmass. It is bounded to
the north and west by the [Central](./central_poasan_diocese.mdx) and
[Southern Poasan Dioceses](./southern_poasan_diocese.mdx), respectively. To the
north east, it meets the
[Gulf of Eternal Dispute](./gulf_of_eternal_dispute.mdx). To the south and east,
Kolha shares borders with three of its former provinces. [Sur](./sur.mdx) and
[Kalamba](./kalamba.mdx) to the east, and [Ar](./ar.mdx) to the south. These
states are 3 of the 5 so-called
[Secessionist Principalities](../misc/secessionist-principalities.mdx) that have
