...
[Ralaka](./ralaka/index.mdx). and the Gizan Peninsula, as well as a
huge portion of the eastern half ot the Mirian Peninsula.

# Geography

Ahuria is one of the largest political entities in
[Thera](./thera.mdx). It is the only known entity with land holdings in
all three continents, with eleven of its fourteen administrative regions, called
_Principalities_, in Ralaka. The twelfth, [Kolha](./kolha.mdx), is in
Southern [Betera](./betera/index.mdx). The thirteenth and fourteenth
are in the westernmost edge of [Tarsa](./tarsa.mdx)
...
[Kolha](./kolha.mdx), Ahuria's twelfth administrative principality, is
...
[Gulf of Eternal Dispute](./gulf_of_eternal_dispute.mdx). To the south
and east, Kolha shares borders with three of its former provinces.
[Sur](./sur.mdx) and [Kalamba](./kalamba.mdx) to the east, and
[Ar](./ar.mdx) to the south. These states are 3 of the 5 so-called
[Secessionist Principalities](../misc/secessionist-principalities.mdx) tnat have
...
is connected by the [Isthmus of Bastion](./isthmus-of-bastion.mdx). On
its eastern shore, the Ahurian possessions of [Giza](./giza.mdx) and
