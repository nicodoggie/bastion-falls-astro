...
[Senera](./senera.mdx). It extends approximately 125 miles inland from the
[Princely Channel](./princely-channel.mdx), with a mouth approximately 63 miles
wide. The gulf serves as the outlet for the [Brams River](./brams-river.mdx),
...
[Kalassarian invasion of Senera](./senera.mdx#kalassarian-invasion), the gulf's
...
features, with [Port Surrey-on-the-Brams](./port-surrey-on-the-brams.mdx)
