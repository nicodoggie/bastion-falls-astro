...
[Beteran continent](./betera/index.mdx). Historically, the various
states that comprise Apgar were once part of the
[Hapgarian Region](./hapgaria.mdx) of the
...
exceptions of [Baraon](./baraon.mdx) and
[Parpelisse](./parpelisse.mdx). Baraon formed a pseudo-state from a
...
By the time of the
[Second Anasaian-Estregan War](../events/second-anasaian-estregan-war.mdx) in the
...
revolts modeled after the [Baraonian Rebellion](../events/baraonian-rebellion.mdx)
...
[First Apgarian Revolution](../events/first-apgarian-revolution.mdx) that started
...
{% see() %}[Fall of the Western Kalassarian Empire](../events/fall-of-the-western-kalassarian-empire.mdx){% end %}
...
[Poasan military](./poasah.mdx#armed-forces) quickly captured the
