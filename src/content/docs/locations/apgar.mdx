...
[Apgarian Articles of Confederation](../notes/apgarian-articles-of-confederation.mdx).
...
exceptions of [Baraon](./baraon.mdx) and [Parpelisse](./parpelisse.mdx). Baraon
formed a pseudo-state from a loose association of communes that have banded
together in mutual defense against neighboring monarchists. Parpelisse on the
other hand formed a proto-democratic state, where electors from the various
guilds elected an executive council to run the territories.
...
[Baraonian Rebellion](../events/baraonian-rebellion.mdx) centuries prior started
cropping up in some of the most authoritarian of regimes in the Apgarian region.
...
[Alsatian Mountains](./alsatian-mountains.mdx) may soon uncover new information
regarding pre-Kalassarian Apgar, but no firm scholarly conclusions have been
made. It is hoped that these ruins may yield documentary evidence, as Kurerans,
even as far back as 3000 PF recorded much about their surrounding cultures, as
proven by some preliminary discoveries from some Mehicanian sites.
...
[Estregans](../ethnicities/estregan.mdx),the
[Anasaians](../ethnicities/estregan.mdx), and the
[Garatonians](../ethnicities/garatonian.mdx) were documented by the Kalassarain
...
<SeeAlso href="../events/fall-of-the-western-kalassarian-empire.mdx" />
...
The first to collapse was the *Kingdom of Geron*, which subdugated the
[Garatonian people](../ethnicities/garatonian.mdx), however, the
[Poasan military](./poasah.mdx#armed-forces) quickly captured the region causing
the subsequent [Garatonian Diaspora](../events/garatonian-diaspora.mdx).
