...
Mountains](./longissian-mountains.mdx) to the west. These mountains form the 
natural border between Kolha and [Southern Poasah](./southern-poasah.mdx).

# History

## Rise to Power
Under [Kolha I](../characters/kolha-i.mdx), the region became a crucial part of the 
[Ahurian Empire](./ahuria.mdx)'s expansion. In 466 AI, Kolha I led Ahurian 
forces in the [Kolhan Invasion](../events/kolhan-invasion.mdx), which culminated in the 
