...
_Seraphine Durant née Gognon_ was the daughter of [Estregan](../locations/estrega.mdx) politician, [Emile Gognon](./emile-gognon.mdx), and
wife to [Port Rainoso](../locations/port-rainoso.mdx) vice-mayor [Degare Durant](./degare-durant.mdx). She is not very well-known in the
...
Her marriage to Durant caused quite a stir. Aside from the fact that Durant's ex-wife [Elodië Durant née Bentayga](./elodie-bentayga.mdx) died a less than a month prior, but also due to the fact the the [Durant family](../families/durant/index.mdx) was once staunchly anti-Masochist, and the [Gognons](../families/gognon/index.mdx) were one of the most devout in Estrega. However, Degare's branch who inter-married with the [Iutlandish](../locations/iutland.mdx) [McFarlands](../families/mcfarland/index.mdx) were not as aggressive in their stance as those of the main one from [Sanery](../locations/sanery.mdx).
