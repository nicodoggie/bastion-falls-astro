...
Even though the group has access to spells like <Spell name="teleport" /> nowadays, the most reliable and economical way to get to [Phantasmagoria](../../events/phantasmagoria.mdx) would be to go through the [Walburton Doorway](../../items/twin-door-of-instantaneous-travel.mdx#walburton-doorway) that connects the [Turbiere de Hubar](../../locations/turbiere-de-hubar.mdx) with the [Walburton Mansion](../../locations/walburton-mansion.mdx). The mansion is being jointly maintained by the [Hags of Hama](../../organizations/hags-of-hama.mdx) and the Hugo branch of [La Camaraderie](../../organizations/la-camaraderie.mdx). Between those two organizations, [Reformist](../../organizations/reformed-church-of-the-divine-masochist.mdx) activity has been practically eradicated in the Western Alsatian Corridor which encompasses the west bank of the [La Furie River](../../locations/la-furie-river.mdx) and the [Anjou Pass](../../locations/anjou-pass.mdx).
