...
Captain's Chambers red - alarm everyone on deck of an attack yellow - autopilot,
coordinates or place  
green - starts tne airship blue - extinguishes fire Rainbow - nondetection

A gargantuan airship seems to have left the docks at Ionguale, seems to be
heavily armed. The bow seems to have something strange on it. Colored grey.
...
Winter Court is allied with most of the people in his realm including the Giants
in the Iron Slag City
...
The Dryads of the Opium Forest doesn't product opium, it's interesting because
it's the only source of the Mordayn herb.
