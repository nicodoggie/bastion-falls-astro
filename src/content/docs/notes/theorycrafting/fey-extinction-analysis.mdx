...
The Silent Ages (435-1225 AI) saw the extinction of most fey species in Thera,
with the notable exception of the [Dolo-Dolo](../../species/dolo-dolo.mdx). This
mass extinction event provides crucial insights into both magical biology and
the nature of planar connections.
...
2. Adaptation Limitations
   ...
   - Required _Ritma_ or enhancer orb assistance
...
2. Human Aggression
   - Kalassarian genocide of [Kurerans](../../species/kureran.mdx)
...
- [Silent Ages Magical Decline](./silent-ages-magical-decline.mdx)
...
class FeyViability: def calculate_survival_chance(self, population, conditions):
""" Model fey population viability """ base_magic = conditions.ambient_magic
orb_support = conditions.enhancer_proximity human_pressure =
conditions.conflict_level
