...
## Walburton Doorway
The *Walburton Doorway* is an example that connects the [Turbiere de Hubar](../locations/turbiere-de-hubar.mdx) in [Raibon Island](../locations/raibon-island.mdx) with the [Walburton Mansion](../locations/walburton-mansion.mdx) in [Hugo](../locations/hugo.mdx), about 1000 miles away. However, because there is a *power source* attached to it, the distance cost is only one 1st-level spell slot.