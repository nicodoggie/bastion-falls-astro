...
{% see() %}[Ansa Ahuriyata](./caste/ansa-ahuriyata.mdx){% end %}
...
{% see() %}[Ahorikishki](./caste/ahorikishki.mdx){% end %}
...
{% see() %}[Akkibati](./caste/akkibati.mdx){% end %}
...
{% see() %}[Provobati](./caste/provobati.mdx){% end %}
...
{% see() %}[Ponsabati](./caste/provobati.mdx){% end %}
...
{% see() %}[Kirsharti](./caste/kirsharti.mdx){% end %}
