...
# Background
[Voracious Land Co.](../organizations/voracious-land-co.mdx), a company owned by wealthy land speculator [Lamarie DeVos](../characters/lamarie-devos.mdx) found 
that a [Garatonian](../ethnicities/garatonian.mdx) reserve in [Aubergine] was seated upon a rich vein of [electrum](https://en.wikipedia.org/wiki/Electrum).

Voracious employs a number of [Dredge Mages](../misc/dredge-mages.mdx) who have access to the spell [legend lore](https://dndbeyond.com/spells/legend-lore) to look
...
# Paula Abdul
DeVos met [Paula Abdul](../characters/paula-abdul.mdx) at curtain call at a production of [Cowl of the Moonlight](../misc/cowl-of-the-moonlight.mdx). Since then,
...
# Performance
Abdul convinced a number of performers in the [Guildenstern Travelling Troupe](../organizations/guildenstern-travelling-troupe.mdx) to stage a performance
in the Garatonian reserve. She drafted a script about the awakening of the [Seed of Destruction](../misc/seed-of-destruction.mdx) in the forests surrounding the prospective mines.
