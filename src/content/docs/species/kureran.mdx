...
Kurerans were a sub-group of [Gnomish](./gnomish.mdx) settlers who fled the
[Feywild](../locations/feywild.mdx) during the
[Great Extinction](../events/great-extinction.mdx) brought about the conflict
between the [Dragons](./dragon.mdx) and the [Giants](./giant.mdx). Having
...
chaotic energies of the [Theran](../locations/thera.mdx) plane. They called this
tradition, [Ritma](../misc/ritma.mdx).

Harnessing the power of Ritma, the Kurerans were able to expand from their first
Theran city of [Korad](../locations/korad.mdx) to become a major power in the
...
- Gnomes flee the Feywild during the
  [Great Extinction](../events/great-extinction.mdx)
...
- Founding of [Korad](../locations/korad.mdx) marks mastery of _Ritma_
...
The Kurerans of [Korad](../locations/korad.mdx), their first and greatest city,
