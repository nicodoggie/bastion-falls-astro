...
norath [no.raθ]
  ...
  : ([borrowed term](./index.mdx#eldrim-borrowings))
...
imlisrur [im.lis.rur]
  ...
  : ([iterative suffix](./index.mdx#iterative-aspect))
...
haran [ha.ran]
  ...
  : See: [Proto-Hick Phonological Processes](../../proto-hick/index.mdx#phonological-processes)
...
stor [stor]
  ...
  : ([final vowel loss](./index.mdx#early-hick))
...
istor [is.tor]
  ...
  : ([initial sibilant loss, final vowel loss](./index.mdx#early-hick))
  : See: [Sacred Terms](#sacred)
...
'ibri ['ib.ri]
  ...
  : ([vowel loss](./index.mdx#sound-changes))
...
venitar [ve.ni.tar]
  ...
  : ([superessive case](./index.mdx#case-system))
...
venuiter [vi.nu.i.ter]
  ...
  : ([ellative case](./index.mdx#case-system))
...
tal [tal]
  ...
  : ([dialectal borrowing](./index.mdx#dialectal-variation))
...
his [his]
  ...
  : [liquid deletion](./index.mdx#sound-changes-in-compounds)
  : See: [Sacred Terms](#sacred)
...
duwes [du.wes]
  ...
  : ([compound fusion, vowel loss](./index.mdx#compound-formation))
...
terok [te.rok]
  ...
  : ([agentive suffix](./index.mdx#agentive-suffix))
...
ai [ai]
  : water
  : Proto-Hick \*ahi → ai
  : ([vowel sequences](./index.mdx#vowel-sequences))
  : See: [Maritime Terms](#maritime-terms), [Water Features](#water-features)
...
dup [dup]
  ...
  : ([final vowel loss](./index.mdx#sound-changes))
...
airur [ai.rur]
  ...
  : ([compound fusion, glottal stop loss](./index.mdx#compound-formation))
...
thimer [θi.mer]
  ...
  : ([vowel reduction, stress shift](./index.mdx#vowel-allophony))
...
grapar [gra.par]
  ...
  : ([liquid deletion](./index.mdx#compound-formation))
...
[Similarity Prefix](./index.mdx#similarity-marking) *ka-* is
used.
...
'imwen [ʔim.wen]
  ...
  : ([compound reduction](./index.mdx#compound-reduction))
...
lithar [li.θar]
  ...
  : ([compound simplification](./index.mdx#compound-formation))
...
wak'ai [wak.ʔai]
  ...
  : ([compound formation, vowel coalescence](./index.mdx#compound-formation))
...
krakrak [kra.krak]
  ...
  : ([nasal deletion](./index.mdx#compound-formation))
...
murvinuiter [mur.vi.nu.i.ter]
  ...
  : ([ellative case](./index.mdx#case-system)) Note:
...
barul [ba.rul]
  ...
  : ([possessive suffix](./index.mdx#possession-marking))
  : Note: One who maintains genealogical records

mobar [mo.bar]
  : unnamed, nameless
  : Proto-Hick mo-bar "NEG-name" → mobar
  : ([negation prefix](./index.mdx#negation-system))
...
-eth [eθ]
  ...
  : Proto-Hick \*etha → eth
  : ([final vowel
  loss](./index.mdx#historical-development))
...
'al-el 'ilitar venuiter-es
  ...
  : See: [Case System](./index.mdx#case-system)
...
See: [Compound Simplification](./index.mdx#compound-simplification)
