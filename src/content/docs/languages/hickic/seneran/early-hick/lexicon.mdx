...
<SeeAlso href="../proto-hick/index.mdx#phonological-processes">
  Proto-Hick Phonological Processes
</SeeAlso>

For stress-related vowel changes, :
<SeeAlso href="../../early-hick/index.mdx#vowel-allophony">
  Vowel Allophony
</SeeAlso>
...
<Lexicon directory='hickic/seneran/early-hick' client:load />
