...
- **Beloved Nurse Lollia** - The pen name of
  [Lollia Skala](../characters/lollia-skala.mdx)
  Tanduarian
- **Horny Healer Shara** - The pen name of
  [Shara Nasari](../characters/shara-nasari.mdx)
  Light Brown Haired, model/actress, Sarebian
  Deflora, Stag Party
- **Katalin the Godly** - The pen name of
  [Katalin Helinski](../characters/katalin-helinski.mdx)
  Short, Tanduarian
...
- **Raunchy Nurse Tharja** - The pen name of
  [Tharja Lutgard](../characters/tharja-lutgard.mdx)
  MILF character, Soniman
- **Sex-Starved Dr. Marina Visconti** - The pen name of
  [Mystine Nightingale](../characters/mystine-nightingale.mdx), a graduate of the
