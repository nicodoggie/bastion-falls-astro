...
{{ loc="Raibon Island" }} due to the [Treaty of Turain](../events/treaty-of-turain.mdx).

# History

In the years following the end of the [Poasan-Apgarian Conflict](../events/poasan-apgarian-conflict/index.mdx), the
[Treaty of Turain](../events/treaty-of-turain.mdx) limited the amount of armed forces on 
{{ loc(name="Raibon Island")}} as a whole. While the 
[Gendarmerie](./gendarmerie-nationale.mdx) had an exception in its existence
