...
organization that handles the \[Kingdom of Senera's] (../locations/senera.mdx)
...
enforcing the [Treaty of Turain](../events/treaty-of-turain.mdx), and
...
[Treaty of Turain](../events/treaty-of-turain.mdx) and maintains Seneran
...
maritime threat: raiders from [Carlmark](../locations/carlmark.mdx),
[Iutland](../locations/iutland.mdx), and
[Fayneland](../locations/fayneland.mdx). Their shallow-draft longships could
