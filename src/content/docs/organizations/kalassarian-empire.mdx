...
The Kalassarian Empire was a continent-spanning state that succeeded the Republic of the Kalassus in 21 PF. At its peak, it spanned from present-day [Senera](../locations/senera.mdx) in the west, most of [Tanduaria](../locations/tanduaria.mdx) up to the [Chokhul mountain range](../locations/chokhul-mountains.mdx) to to north, the western edges of present-day Sarebia in the east, and portions of northern Ralaka to the south.
