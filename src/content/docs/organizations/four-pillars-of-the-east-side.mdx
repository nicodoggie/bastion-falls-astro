...
The Four Pillars are a local name for 4 prominent people that operate a variety of businesses across a broad  spectrum of legal questionability. All four groups have great influence in [Port Rainoso](../locations/port-rainoso.mdx), but base their operations on the East Side--the area of Rainoso in the eastern bank of the [Samain River](../locations/samain-river.mdx).
