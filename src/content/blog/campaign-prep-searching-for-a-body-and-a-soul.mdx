...
[Alsatian Mountains](../docs/locations/alsatian-mountains.mdx), a long mountain range
that extends throughout the entirety of the [Apgarian](../docs/locations/apgar.mdx)
[province of Alsace](../docs/locations/alsace.mdx). The player characters involved are
the following:
...
[Hugo](../docs/locations/hugo.mdx). The former are merely traveling into the Mountains
via the doorway that connects it with the
[Turbiere de Hubar](../docs/locations/turbiere-de-hubar.mdx) in order to quickly head
into [Mayonne](../docs/locations/mayonne.mdx), where supposedly the soulless body of
[Matthew V Strandiz](../docs/characters/matthew-v-strandiz.mdx) is wandering. The
...
[Phantasmagoria](../docs/events/phantasmagoria.mdx) is set to happen on the 13th day of
...
[Free Theater](../docs/organizations/free-theater.mdx) had disposed of Matthew
...
connects [Raibon Island](../docs/locations/raibon-island.mdx) with
[Walburton House]("@/locations/walburton-house.md) in Hugo. They routinely
ensure that any [Reformist](../docs/religions/reformed-divine-masochist.mdx) agents are
...
[Sarebia](../docs/locations/sarebia.mdx) and [Haram](../docs/locations/haram.mdx). These
...
But why separate his body from his soul at all?
  : Well, he's a high-level caster and was causing them trouble.
    ...
    <HomebrewSpell name="mass scrying" target="mass scrying" /> that
...
<dl>
  ...
  <dd>
    <p>As his soul has been collected for whatever reason, his body may have had its value, but Andre Delarde had some beef with the man and wanted to basically desecrate his body. Placing some kind of enchantment and illusion spell on Matthew Strandiz' body as it meanders in Mayonne's city streets as some kind of cruel punishment.</p>
    <p>It's been a while at this point, so the body has likely been collected. I haven't decided who yet... I do have time until we get to Mayonne tho, and I do want to get to that location for sure.</p>
    ...
    <p>Option 2: Some internal faction ahd used his body to further their goals</p>
    <p>Option 3: Reformists use his body for breeding purposes. His soul might be absent, but his body definitely has those magical Strandiz genes.</p>
  </dd>
  <dt>Why do they actually want to go to Phantasmagoria?</dt>
  <dd>
    Originally, Hedwig, Cotto and the others want to go to Phantasmagoria for the simple reason that the occult interests them greatly. Though they still have great interest in the occult, they've since grown to face the responsibilities that they've been bestowed. The date of Phantasmagoria is too close to the execution of the crew of the [Principium](../docs/vehicles/principium.mdx) for them to have the time to join. Since Narmaya wants to learn about the other known vampire though, Phantasmagoria may be the best chance for just that.
  </dd>
</dl>
