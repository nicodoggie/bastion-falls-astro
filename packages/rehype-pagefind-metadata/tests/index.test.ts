...
import { rehypePagefindMetadata, type BastionFallsCharacterVFile } from '../src/index.js';
...
describe('rehypePagefindMetadata', () => {
  ...
  it('should return the tree if there is no frontmatter', () => {
    ...
    const mockTree: Root = { type: 'root', children: [] };
    const tree = plugin(mockTree, new VFile() as BastionFallsCharacterVFile);
